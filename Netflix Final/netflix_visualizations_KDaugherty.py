...
# Days
# Different stocks 
# the addition of a column indicating the financial quarter
...
# Line chart of NFLX stock price
sns.set_style("whitegrid")
plt.plot("Date", "Price", data=netflix_stocks, marker='o', color='red')
plt.title("Netflix Daily Closing Price")
sns.despine()
...
plt.legend(["Actual","Estimate"],loc=4)  #4 = lower right
...
plt.title("Netflix Quarterly Earnings and Revenue")
...
plt.suptitle('2017 Stock Comparison', fontsize=14)
